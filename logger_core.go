...
//
// This needs to be usually implemented by loggers that interface with the
...
type CoreLogger interface {
	...
	// this using Accepts().
	//
	// skipFrames defines how many frames should be skipped to determine the real
	// caller of the log event from the call stack. In case of delegating,
